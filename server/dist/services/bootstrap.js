...
exports.ACTIVITY_CATALOG = void 0;
exports.ensureActivityCatalog = ensureActivityCatalog;
exports.ensureDefaultPaymentMethod = ensureDefaultPaymentMethod;
exports.ACTIVITY_CATALOG = [
...
async function ensureActivityCatalog(prisma) {
    await Promise.all(exports.ACTIVITY_CATALOG.map((activity) => prisma.activity.upsert({
...
async function ensureDefaultPaymentMethod(prisma, userId) {
